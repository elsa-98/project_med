			...
			<div class="container-fluid bg-style media1">
				...
				<div class="row">
					...
					<div class="col-md-12 log-style">
						<form action="adminauthentication.php" name="login" method="post" onsubmit="return validateForm()" class="m-auto py-3 jumbotron text-light p-3 form-style rounded">

							
							<h3 div class="text-center text-dark">Sign In</h3>
								<input type="text" class="form-control inputcomponent mt-md-3 space" name='username'  placeholder="Username" required="required">
							
								<input type="password" class="form-control inputcomponent mt-md-3 space" name='password'  placeholder="Password" required="required">
