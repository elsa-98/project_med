...
<!-- Page Wrapper -->
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div class="side">
				<ul>
					<li>
                        <a href="doctorslist.php"> Doctors List</a></li>
                 </ul>
          </div>
          ...
          <div class="side">
				<ul>
					<li>
						...
						<div class="subside">
							<ul>
								<li><a href="patientavailableapp.php">Available appointments</a></li>
								<li><a href="patientbookapp.php">Book Appointments</a></li>
							</ul>
						</div>
					</li>
                 </ul>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div>
          <img src="img/consultancy.jpg">
      </div>
       <!-- Footer -->
       <footer class="">
          <div class="copyright text-center bg-gradient-primary py-2 text-light">
            <span>Copyright &copy; Gemini consultancy 2019-2020</span>
        </div>
      </footer>
      <!-- End of Footer -->
